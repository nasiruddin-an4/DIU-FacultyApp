        ...
        <div className="bg-white/95 backdrop-blur-md border-b border-gray-200 shadow-sm">
          ...
          >
            {tabConfig?.map((tab) => (
              <button
                key={tab.id}
                className={`relative flex flex-col items-center px-4 py-3 min-w-[120px] md:min-w-[140px] focus:outline-none transition-all duration-300 ease-in-out group cursor-pointer ${
                  activeTab === tab.id
